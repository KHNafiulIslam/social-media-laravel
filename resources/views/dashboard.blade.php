...
@section('center')
    <div class="col-sm-6">
        <div class="post col-sm-12" id="new_post">
            <div class="row post-heading" style="background: skyblue;">
                <div class="col-sm-12">
            ...
            <div class="post col-sm-12" id="post_1">
                ...
                <div class="row post-action">
                    <ul class="post-action-menu">
                        ...
                        <li class="pull-right"><a href="" class="text-mute"><span id="post_share_count_1">{{$post['share']}}</span> Shares</a></li>
                    ...
                    <div class="row">
                        <form action="{{route('saveComment')}}" method="POST">
                            ...
                            <div class="col-sm-9 form-group">
                                <textarea rows="1" name="comments" class="comment-text" placeholder="Add Comment" oninput="auto_height(this)"></textarea>
                            </div>
